...
public class MemberController {
	...
	@GetMapping("/mypage")
	public String mypage(@AuthenticationPrincipal(expression = "member") Member member, Model model) {
	...
	@GetMapping("/edit")
	public String editForm(@AuthenticationPrincipal(expression = "member") Member member, Model model) {
	...
	public String withdraw(@AuthenticationPrincipal(expression = "member") Member member, RedirectAttributes ra) {
	...
	@GetMapping("/profile")
	public String profileForm(@AuthenticationPrincipal(expression = "member") Member member, Model model) {
