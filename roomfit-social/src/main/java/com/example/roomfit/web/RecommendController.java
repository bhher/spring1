...
public class RecommendController {
	...
	@GetMapping
	public String survey(@AuthenticationPrincipal(expression = "member") Member member) {
	...
	@GetMapping("/result")
	public String result(@AuthenticationPrincipal(expression = "member") Member member, Model model) {
		if (userProfileService.findByMemberId(member.getId()) == null) {
			return "redirect:/member/profile";
		}
